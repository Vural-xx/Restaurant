        ...
        builder.setView(inflater.inflate(R.layout.activity_dialog_add, null))
                ...
                .setPositiveButton(R.string.accept, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Restaurant myRestaurant = new Restaurant(1, editTextName.toString(), editTextStreet.toString(), editTextPlace.toString(), editTextZip.toString(), editTextPath.toString(), editTextComments.toString());
